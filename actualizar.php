...
<?php
	...
	if ($tab=='a') 
	{
		...
		echo '<link href="css/actualizar.css" type="text/css" rel="stylesheet">';
		...
		while ($fila =mysqli_fetch_array($resultado))
		{
			...
			echo "</table>";
			echo "<hr>";
			echo "<a href='prueba2/index.php'><h3 align=center >Volver</h3></a>";
		}
	}
	...
	else if($tab=='u') 
	{
        ...
        while ($fila =mysqli_fetch_array($resultado)) 
        {
			...
			echo "</tr>";
			echo "<tr>";
			echo "<td><label>Contraseña:</label></td> <td><input class='form-control' type = 'text' name = 'contrasena' value = '".$fila['password']."' required></td>";
			echo "</tr>";
			echo "<tr>";
