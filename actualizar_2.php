...
<?php
	...
	else if ($tab=='u') 
	{
		...
		$consulta="UPDATE usuarios SET username='$nuevousuario', password='$contrasena', privilegio='$privilegio' WHERE username='$user'";
	   ...
	   $resultado=mysqli_query($conexion, $consulta);
		...
		echo "<script> location.href='prueba2/index.php'; </script> ";
